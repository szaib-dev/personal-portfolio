          ...
          <div className="relative m-0 block h-screen w-full max-[900px]:grid max-[900px]:h-auto max-[900px]:gap-7 max-[900px]:px-0 max-[900px]:py-20">
            ...
            >
              ...
              <div className="group relative ml-[0.05rem] mt-8 h-[29.75rem] w-[17.5rem] max-[900px]:ml-0 max-[900px]:h-[27.25rem] max-[900px]:w-[16rem]">
                ...
                <div className="absolute inset-0 box-border overflow-hidden bg-white p-[14px] shadow-[0_10px_24px_rgba(0,0,0,0.085)] transition-all duration-300 ease-out group-hover:translate-x-[0.35rem] group-hover:translate-y-[0.22rem] group-hover:rotate-[-0.6deg] group-hover:opacity-0">
                  <Image
